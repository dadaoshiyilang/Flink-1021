...
//      .assignAscendingTimestamps(_._2) 类似上面的assignTimestampsAndWatermarks
...
//  }
  ...
  class MyAssigner extends  AssignerWithPeriodicWatermarks[(String,Long)] {
    ...
    val bound = 10 * 1000L // 最大延迟时间是10s

    var maxTs = Long.MinValue + 10 * 1000 + 1
